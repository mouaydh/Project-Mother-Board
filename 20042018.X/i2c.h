...
void AckI2C1(void) ;//__ ((section (".libperi")));

void CloseI2C1(void) ;//__ ((section (".libperi")));

void ConfigIntI2C1(unsigned int) ;//__ ((section (".libperi")));

char DataRdyI2C1(void) ;//__ ((section (".libperi")));

#define SlavegetcI2C1 SlaveReadI2C1

#define MastergetcI2C1 MasterReadI2C1

unsigned int SlavegetsI2C1(unsigned char *, unsigned int) ;//__ ((section (".libperi")));

unsigned int MastergetsI2C1(unsigned int length, unsigned char * rdptr, unsigned int i2c_data_wait) ;//__ ((section (".libperi")));

void IdleI2C1(void) ;//__ ((section (".libperi")));

void NotAckI2C1(void) ;//__ ((section (".libperi")));

void OpenI2C1(unsigned int,unsigned int) ;//__ ((section (".libperi")));

unsigned int MasterputsI2C1(unsigned char *) ;//__ ((section (".libperi")));

unsigned int SlaveputsI2C1(unsigned char *) ;//__ ((section (".libperi")));

#define SlaveputcI2C1 SlaveWriteI2C1

#define MasterputcI2C1 MasterWriteI2C1

unsigned char SlaveReadI2C1(void) ;//__ ((section (".libperi")));

unsigned char MasterReadI2C1(void) ;//__ ((section (".libperi")));

void SlaveWriteI2C1(unsigned char) ;//__ ((section (".libperi")));

char MasterWriteI2C1(unsigned char) ;//__ ((section (".libperi")));

void RestartI2C1(void) ;//__ ((section (".libperi")));

void StartI2C1(void) ;//__ ((section (".libperi")));

void StopI2C1(void) ;//__ ((section (".libperi")));


/************************************************************
Fonctions réalisées par le club robotique
*/
